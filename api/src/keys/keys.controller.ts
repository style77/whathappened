import { Body, Controller, Get, NotFoundException, Patch, Post, Query, Req, UseGuards } from '@nestjs/common';
...
export class KeysController {
    ...
    list(@Req() req,
        ...
        return this.keysService.findAllUserKeys(user, { page, limit, sort, order, filter });
    }
